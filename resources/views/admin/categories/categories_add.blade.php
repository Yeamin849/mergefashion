                ...
                <form action="{{ $url }}" method="POST">
                    ...
                    <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-3">
                            <label for="catId" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                                Category ID
                            </label>
                        </div>
                        <!-- End Col -->
                        ...
                        <div class="sm:col-span-9">
                            <input id="catId" type="number" name="catId"
                                ...
                                placeholder="1000" value="{{ $category_data->catId }}" required>
                        </div>

                        <!-- End Col -->

                        <div class="sm:col-span-3">
                            <label for="catName" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                                Category Name
                            </label>
                        </div>
                        <!-- End Col -->
                        ...
                        <div class="sm:col-span-9">
                            <input id="catName" type="text" name="catName"
                                class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                                placeholder="Category Name" value="{{ $category_data->catName }}" required>
                        </div>
