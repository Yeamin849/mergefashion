                                            ...
                                            <div class="inline-flex gap-x-2">
                                                ...
                                                @can('write')
                                                    <a class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
                                                        href="{{ route('admin.categories_addPage') }}">
                                            ...
                                            @foreach ($categories as $categorie)
                                                <tr>
                                                    <td class="h-px w-72 whitespace-nowrap">
                                                        <div class="px-6 py-3">
                                                            <span
                                                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $categorie->id }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="h-px w-72 whitespace-nowrap">
                                                        <div class="px-6 py-3">
                                                            <span
                                                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $categorie->catId }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="h-px w-72 whitespace-nowrap">
                                                        <div class="px-6 py-3">
                                                            <span
                                                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $categorie->catName }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="h-px w-px whitespace-nowrap">
                                                        @can('edit')
                                                            <div class="px-6 py-1.5">
                                                                <a class="inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 hover:underline font-medium"
                                                                    href="{{ route('admin.category_edit', ['id' => $categorie->id]) }}">
                                                                    Edit
                                                                </a>
                                                            </div>
                                                        @endcan
                                                        @can('delete')
                                                            <div class="px-6 py-1.5">
                                                                <form
                                                                    action="{{ route('admin.category_delete', ['id' => $categorie->id]) }}"
                                                                    method="POST"
