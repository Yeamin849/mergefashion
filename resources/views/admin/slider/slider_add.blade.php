                ...
                <form action="{{ $url }}" method="POST">
                    ...
                    <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-3">
                            <label for="img_url" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                                Slider Img url
                            </label>
                        </div>
                        <!-- End Col -->
                        ...
                        <div class="sm:col-span-9">
                            <input id="img_url" type="url" name="img_url"
                                ...
                                placeholder="url" value="{{ $slider_data->img_url }}" required>
                        </div>
                        ...
                        <div class="sm:col-span-9">
                            <input id="target_url" type="url" name="target_url"
                                class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                                placeholder="url" value="{{ $slider_data->target_url }}" required>
                        </div>
