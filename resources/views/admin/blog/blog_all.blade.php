                                            ...
                                            @foreach ($blogs as $blog)
                                                <tr>
                                                    <td class="h-px w-72 whitespace-nowrap">
                                                        <div class="px-6 py-3">
                                                            <span
                                                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $blog->id }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="h-px w-72 whitespace-nowrap">
                                                    ...
                                                    <td class="h-px w-72 whitespace-nowrap">
                                                        <div class="px-6 py-3">
                                                            <span
                                                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $blog->title }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="h-px w-72 whitespace-nowrap">
                                                        <div class="px-6 py-3">
                                                            <span
                                                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $blog->date }}</span>
                                                        </div>
                                                    </td>
                                                                ...
                                                                <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden divide-y divide-gray-200 min-w-[10rem] z-20 bg-white shadow-2xl rounded-lg p-2 mt-2 dark:divide-gray-700 dark:bg-gray-800 dark:border dark:border-gray-700"
                                                                    ...
                                                                    <div class="py-2 first:pt-0 last:pb-0">
                                                                        ...
                                                                        @can('edit')
                                                                            ...
                                                                            @if ($blog->status == 0)
                                                                                <a class="flex items-center gap-x-3 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                                                                    href="{{ route('admin.blog_status', ['id' => $blog->id, 'status' => 1]) }}">
                                                                                    Publish
                                                                                </a>
                                                                            @else
                                                                                <a class="flex items-center gap-x-3 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                                                                    href="{{ route('admin.blog_status', ['id' => $blog->id, 'status' => 0]) }}">
                                                                                    Unpublish
                                                                                </a>
                                                                            @endif
                                                                        @endcan
                                                                    ...
                                                                    @can('delete')
                                                                        <div class="py-2 first:pt-0 last:pb-0">
                                                                            <form
                                                                                action="{{ route('admin.blog_delete', ['id' => $blog->id]) }}"
                                                                                method="POST"
