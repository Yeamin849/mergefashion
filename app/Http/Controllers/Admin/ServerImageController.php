...
class ServerImageController extends Controller
{
    ...
    {
        return view('admin.server_image.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $folderPath = public_path('images/server/' . date('d_m_Y'));
        ...
        $resizeImage = Image::make($image)->fit(1920, 1080);
    ...
    {
        $imagePath = public_path('images/server');
        ...
        return view('admin.server_image.index', ['folders' => $folders]);
    ...
    {
        $imagePath = public_path('images/server/' . $folder . '/' . $image);
    ...
    public function deleteFolder($folderName)
    {
        ...
        $folderPath = public_path('images/server/' . $folderName);
